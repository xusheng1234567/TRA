...
def main(config, fold_id):
    ...
    add_folds_data=folds_data[fold_id][0][36:37:1]
    folds_data[fold_id][0]=folds_data[fold_id][0][:36:1]

    data_loader, valid_data_loader,adds_loader, data_count = data_generator_np(folds_data[fold_id][0],
